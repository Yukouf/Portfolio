            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <Mail className="w-5 h-5 text-watchdogs-blue" />
                  <span className="ai-text">Youssef.guerniou@proton.me</span>
                </div>
                <div className="flex items-center space-x-3">
                ...
                <div className="flex items-center space-x-3">
                  <Phone className="w-5 h-5 text-watchdogs-blue" />
                  <span className="ai-text">06 20 01 95 27</span>
                </div>
              </div>
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
